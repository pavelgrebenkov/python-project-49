...
### Installation
<p>To install the package type this command in the terminal:</p></br />
<p>python3 -m pip install --user git+https://github.com/pavelgrebenkov/python-project-49.git</p>
